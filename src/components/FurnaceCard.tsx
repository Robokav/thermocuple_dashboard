...
import { Flame, Settings2, Save, RotateCcw, Target, Edit2, Check, X } from 'lucide-react';
    ...
    <div className="bg-surface-container-low rounded-xl border border-outline-variant/20 overflow-hidden shadow-xl transition-all hover:border-primary/30">
      ...
      <div className="p-4 space-y-4">
        ...
        <button 
          ...
          className={`w-full py-2.5 flex items-center justify-center gap-2 font-bold font-body text-[10px] uppercase tracking-widest rounded transition-all ${
            isWizardOpen ? 'bg-primary text-on-primary' : 'bg-primary/10 border border-primary/30 text-primary hover:bg-primary/20'
          }`}
        >
          <Settings2 className="w-4 h-4" />
          {isWizardOpen ? 'Close Wizard' : 'Calibration Wizard'}
        </button>
